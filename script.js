...
const account2 = {
  ...
  movementsDates: [
    ...
    '2022-06-07T09:48:16.867Z',
    '2022-06-05T06:04:23.907Z',
    '2022-06-09T14:18:46.235Z',
  ],
  currency: 'USD',
  locale: 'en-US',
};
...
//Displaying the account movements
const displayMovements = function (acc, sort = false) {
  ...
  movs.forEach(function (mov, i) {
    ...
    // currency formatting Intl.NumberFormate
...
//The balance calculation With reduce method
...
//All summary of account  In and Out by map, filter, reduce method
...
// Creating a Username by sting methods and forEach loop
...
const startLogOutTimer = function () {
  const tic = function () {
    ...
    if (time === 0) {
      clearInterval(timer);
      labelWelcome.textContent = `Login to get start again!`;
